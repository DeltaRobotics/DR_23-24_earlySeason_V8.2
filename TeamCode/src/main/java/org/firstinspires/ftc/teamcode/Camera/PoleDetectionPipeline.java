...
// Credits to team 7303 RoboAvatars, adjusted by team 3954 Pink to the Future, adjusted by team 9925 Delta Robotics
...
public class PoleDetectionPipeline extends OpenCvPipeline
{
    ...
    public int borderLeftX   = 0;   //amount of pixels from the left side of the cam to skip
    public int borderRightX  = 0;   //amount of pixels from the right of the cam to skip
    public int borderTopY    = 0;   //amount of pixels from the top of the cam to skip
    public int borderBottomY = 0;   //amount of pixels from the bottom of the cam to skip
