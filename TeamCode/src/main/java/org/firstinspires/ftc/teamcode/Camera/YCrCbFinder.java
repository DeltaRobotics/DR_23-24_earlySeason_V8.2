...
@Autonomous(name="YCrCbFinder")
@Disabled
public class YCrCbFinder extends LinearOpMode {
    ...
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 250.0, 100);
    ...
    public void testing(PoleDetectionPipeline myPipeline){
